...
def category(request):
    ...
    if request.method == 'POST':
        ...
        your_message = "Your trusted gift shop in Thika offering premium, personalized, and same-day Gifts & Flowers delivery services"
        subject = "Shee Gifts & Flowers updates"
